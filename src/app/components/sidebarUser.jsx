        ...
        <div className=" shadow fixed flex flex-col hidden lg:flex w-[200px] h-100v overflow-hidden text-gray-700 bg-gray-100 " id={props.classe}>
            ...
            <a className="flex w-full py-4 justify-center border-t-2" id={props.name}>
                <div className="flex items-center gap-4 mx-4">
                    <img className="h-[45px] rounded-full" src="https://yt3.ggpht.com/OTQq_1COYbZ1vY9sBj7Z4Ki1Q0iYRDsMSPjDtIxD2iS-jaUbvOsfhB7p7-mIg_LjGX9YkNjM-A=s108-c-k-c0x00ffffff-no-rj" alt=""/>
                    <div className="font-medium dark:text-white">
                        <div>Max Rivera</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">Usuario</div>
                    </div>
                </div>
            </a>
                ...
                <div class="container max-w-screen-lg mx-auto">
                    <div class="flex justify-center items-center w-screen h-screen">
                        ...
                        <h1 class="font-bold text-3xl">Formulario de reportes</h1>
                            <div class="w-full p-8 my-4 md:px-6 lg:w-55v lg:pl-10 lg:pr-10 mr-auto">
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 mt-2">
                                    ...
                                    <select id="tipoReporte" name="tipoReporte" form="tipoReporteForm" class="w-full bg-gray-100 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                                ...
                                <div class="grid mt-2">
                                    ...
                                    <input className="w-full  bg-gray-100 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline h-[200px]"
                                    type="text" placeholder="Descripcion" />
                                </div>
                                <div class="py-20 px-2 flex items-center justify-center">
                                                ...
                                                <div class="relative border-dotted h-48 rounded-lg border-dashed border-2 border-blue-700 bg-gray-100 flex justify-center items-center">
                                                    <div class="absolute">
                                                        <div class="flex flex-col items-center">
                                                            ...
                                                            <span class="block text-gray-400 font-normal">Sube aquí tu evidencia</span>
                                                        </div>
                                                    </div>
